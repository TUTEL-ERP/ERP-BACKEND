...
namespace server.Repository
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public async Task<DataTable> ExecuteProcedureAsync(string usrname, CustomerAction action, CustomerRequestDto request)
        {
            using var connection = new SqlConnection(_context.Database.GetConnectionString());
            using var cmd = new SqlCommand("SP_CUSTOMER_SETUP", connection);
