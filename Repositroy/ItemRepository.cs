...
namespace server.Repository
{
    public class ItemRepository : IItemRepository
    {
        ...
        public async Task<DataTable> ExecuteProcedureAsync(string usrname, ItemAction action, ItemRequestDto request)
        {
            using var connection = new SqlConnection(_context.Database.GetConnectionString());
            using var cmd = new SqlCommand("SP_ITEM_SETUP", connection);
