...
namespace server.Repository
{
    public class CompanyRepository : ICompanyRepository
    {
        ...
        public async Task<DataTable> ExecuteProcedureAsync(string usrname, CompanyAction action, CompanyRequestDto request)
        {
            using var connection = new SqlConnection(_context.Database.GetConnectionString());
            using var cmd = new SqlCommand("SP_COMPANY_SETUP", connection);
