...
namespace server.Repositroy
{
    public class BranchRepository : IBranchRepository
    {
        ...
        public async Task<DataTable> ExecuteProcedureAsync(string usrname, BranchAction action, BranchRequestDto request)
        {
            using var connection = new SqlConnection(_context.Database.GetConnectionString());
            using var cmd = new SqlCommand("SP_BRANCH_SETUP", connection);
