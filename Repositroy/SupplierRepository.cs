...
namespace server.Repository
{
    public class SupplierRepository : ISupplierRepository
    {
        ...
        public async Task<DataTable> ExecuteProcedureAsync(string usrname, SupplierAction action, SupplierRequestDto request)
        {
            using var connection = new SqlConnection(_context.Database.GetConnectionString());
            using var cmd = new SqlCommand("SP_SUPPLIER_SETUP", connection);
