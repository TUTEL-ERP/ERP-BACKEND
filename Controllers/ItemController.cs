    ...
    public class ItemController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetGridData(string formName)
        {
            try
            {
                ...
                var request = new ItemRequestDto { formId = formName, data = JsonDocument.Parse("{}").RootElement };
        ...
        public async Task<IActionResult> SelectRecord(int id)
        {
            try
            {
                ...
                var request = new ItemRequestDto { recordId = id.ToString(), data = JsonDocument.Parse("{}").RootElement };
        ...
        public async Task<IActionResult> InsertRecord([FromBody] ItemRequestDto request)
        {
            try
            {
                var userid = GetUserId();
        ...
        public async Task<IActionResult> UpdateRecord([FromBody] ItemRequestDto request)
        {
            try
            {
                var userid = GetUserId();
