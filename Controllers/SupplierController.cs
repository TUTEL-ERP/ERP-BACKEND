    ...
    public class SupplierController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetGridData(string formName)
        {
            try
            {
                ...
                var request = new SupplierRequestDto { formId = formName, data = JsonDocument.Parse("{}").RootElement };
        ...
        public async Task<IActionResult> SelectRecord(int id)
        {
            try
            {
                ...
                var request = new SupplierRequestDto { recordId = id.ToString(), data = JsonDocument.Parse("{}").RootElement };
        ...
        public async Task<IActionResult> InsertRecord([FromBody] SupplierRequestDto request)
        {
            try
            {
                var userid = GetUserId();
        ...
        public async Task<IActionResult> UpdateRecord([FromBody] SupplierRequestDto request)
        {
            try
            {
                var userid = GetUserId();
