    ...
    public class DepartmentController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetGridData(string formName)
        {
            try
            {
                ...
                var request = new DepartmentRequestDto { formId = formName, data = JsonDocument.Parse("{}").RootElement };
        ...
        public async Task<IActionResult> SelectRecord(int id)
        {
            try
            {
                ...
                var request = new DepartmentRequestDto { recordId = id.ToString(), data = JsonDocument.Parse("{}").RootElement };
        ...
        public async Task<IActionResult> InsertRecord([FromBody] DepartmentRequestDto request)
        {
            try
            {
                var userid = GetUserId();
        ...
        public async Task<IActionResult> UpdateRecord([FromBody] DepartmentRequestDto request)
        {
            try
            {
                var userid = GetUserId();
