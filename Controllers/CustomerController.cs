    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetGridData(string formName)
        {
            try
            {
                ...
                var request = new CustomerRequestDto { formId = formName, data = JsonDocument.Parse("{}").RootElement };
        ...
        public async Task<IActionResult> SelectRecord(int id)
        {
            try
            {
                ...
                var request = new CustomerRequestDto { recordId = id.ToString(), data = JsonDocument.Parse("{}").RootElement };
        ...
        public async Task<IActionResult> InsertRecord([FromBody] CustomerRequestDto request)
        {
            try
            {
                var userid = GetUserId();
        ...
        public async Task<IActionResult> UpdateRecord([FromBody] CustomerRequestDto request)
        {
            try
            {
                var userid = GetUserId();
