    ...
    public class BranchController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetGridData(string formName)
        {
            try
            {
                ...
                var request = new BranchRequestDto { formId = formName, data = JsonDocument.Parse("{}").RootElement };
                var dt = await _branchService.GetGridDataAsync(userid, request);
        ...
        public async Task<IActionResult> SelectRecord(int id)
        {
            try
            {
                ...
                var request = new BranchRequestDto { recordId = id.ToString(), data = JsonDocument.Parse("{}").RootElement };
                var dt = await _branchService.SelectRecordAsync(userid, request);
        ...
        public async Task<IActionResult> InsertRecord([FromBody] BranchRequestDto request)
        {
            try
            {
                var userid = GetUserId();
                ...
                var dt = await _branchService.InsertRecordAsync(userid, request);
        ...
        public async Task<IActionResult> UpdateRecord([FromBody] BranchRequestDto request)
        {
            try
            {
                var userid = GetUserId();
                ...
                var dt = await _branchService.UpdateRecordAsync(userid, request);
                return dt.Rows.Count > 0
                    ? Ok(ApiResponseHelper.Sucess(null, dt.Rows[0][0].ToString()))
                    : Ok(ApiResponseHelper.Fail("No response received"));
            }
        ...
        public async Task<IActionResult> DeleteRecord(int id)
        {
            try
            {
                ...
                var request = new BranchRequestDto { recordId = id.ToString(), data = JsonDocument.Parse("{}").RootElement };
                var dt = await _branchService.DeleteRecordAsync(userid, request);
                return dt.Rows.Count > 0
                    ? Ok(ApiResponseHelper.Sucess(null, dt.Rows[0][0].ToString()))
                    : Ok(ApiResponseHelper.Fail("No response received"));
            }
